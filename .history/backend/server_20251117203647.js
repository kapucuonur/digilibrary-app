...
// Google Books verisini formatla - GÜNCELLENMİŞ
const formatBookData = (googleBook) => {
  ...
  const averageRating = volumeInfo.averageRating ? 
    ...
    parseFloat((Math.random() * 2 + 3).toFixed(1)); // 3.0-5.0 arası
  ...
  return {
    ...
    totalCopies: 5,
    averageRating: averageRating, // Artık number
    totalRatings: totalRatings, // Artık number
    // Google Books ekstra bilgileri
    googleBooksId: id,
